...
/**
 * Products shown on the public site. Single source of truth — the Home and
 * Products pages both derive from this collection, so the lineup can never
 * drift to a product that does not exist here.
 *
